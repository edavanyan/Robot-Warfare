...
namespace UnityMovementAI.Scripts.Camera
{
    ...
    public class InfiniteGrid : MonoBehaviour
    {
        ...
        void GetGridBounds()
        {
            float distAway = UnityEngine.Camera.main.WorldToViewportPoint(gridLocation).z;
            ...
            Vector3 bottomRight = UnityEngine.Camera.main.ViewportToWorldPoint(new Vector3(1, 0, distAway));
            Vector3 topLeft = UnityEngine.Camera.main.ViewportToWorldPoint(new Vector3(0, 1, distAway));
