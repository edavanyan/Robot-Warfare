...
namespace UnityMovementAI.Scripts.Units.Movement
{
    ...
    public class SteeringBasics : MonoBehaviour
    {
        ...
        [Header("Arrive")] public float targetRadius = 0.005f;
        ...
        [Header("Look Direction Smoothing")] public bool smoothing = true;
