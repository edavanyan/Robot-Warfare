...
namespace UnityMovementAI.Scripts
{
    public class Spawner : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            float distAway = UnityEngine.Camera.main.WorldToViewportPoint(Vector3.zero).z;

            bottomLeft = UnityEngine.Camera.main.ViewportToWorldPoint(new Vector3(0, 0, distAway));
            Vector3 topRight = UnityEngine.Camera.main.ViewportToWorldPoint(new Vector3(1, 1, distAway));
